...
class ProffesionSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RegisterProfessionController>(builder: (controller) {
      return ListView(
        children: [
          ...
          MixButton(
            ...
            onPressedRight: controller.selectedEducation != null &&
          ...
          //   decoration: BoxDecoration(
          //       borderRadius: theme.style.borderRadius.allSmall,
          //       color: controller.selectedProffesion == null
          //           ? kSofterGrey
          //           : kWhiteColor,
          //       border: theme.style.boder),
          //   child: controller.specializationLoading
          //       ? const Center(
          //           child: CupertinoActivityIndicator(
          //           color: kPrimaryAccentColor,
          //         ))
          ...
          //             size: 22.r,
          //           ),
          //           items: controller.specialization
          //               .map((e) => DropdownMenuItem<Specialization>(
          //                   value: e, child: Text(e.subProfessionName ?? '')))
          //               .toList(),
          //           onChanged: (value) =>
          //               controller.selectSpecialization(value!)),
          // ),
          // Gap(36.h),
          // MixButton(
          //   isLoading: controller.uploadProfessionDataLoading,
          ...
          //   textRight: 'Selanjutnya',
          //   onPressedLeft: () => controller.previous(),
          //   onPressedRight: controller.selectedProffesion != null &&
