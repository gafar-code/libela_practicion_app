...
import 'package:libela_practition/app/features/auth/presentation/pages/forgot_otp/controllers/forgot_otp_controller.dart';
...
class FormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ForgotOtpController>(builder: (controller) {
      return Padding(
