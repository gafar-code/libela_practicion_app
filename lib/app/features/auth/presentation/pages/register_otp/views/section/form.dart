...
import 'package:libela_practition/app/features/auth/presentation/pages/register_otp/controllers/register_otp_controller.dart';
...
class FormSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RegisterOtpController>(builder: (controller) {
      return Padding(
